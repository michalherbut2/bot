...
module.exports = {
  ...
  async run(client, interaction) {
    ...
    const thumbnail = "https://media.discordapp.net/attachments/1216104890976305162/1216201330549456926/Logoonew.png?ex=6611fbc1&is=65ff86c1&hm=50ceb9b9c349f96013743bd5bb672e231bbad5e233123921185bf65e8b516e45&format=webp&quality=lossless&width=586&height=586&"
    
    // const footerText = "©️COPYRIGHT VIRAL BUZZ 2024";

    sendEmbed(channel, {
      title: "Viral Buzz - Rules",
      description: `**Discord Community Guidelines:**
